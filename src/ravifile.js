    ...
    return (
        <div className="head">
            ...
            <div className="headright">
                <VideoCallIcon className="righticon"/>
                <AppsIcon className="righticon"/>
                <NotificationsIcon className="righticon"/>
                <Avatar alt="Bikash" src="https://yt3.ggpht.com/a/AATXAJyR7L2HcfcpbjY7w10nsTZfsfCEpuIcMpEPz3c83w=s176-c-k-c0x00ffffff-no-rj"/>
            </div>
